    ...
    <div className="w-full bg-white py-4 px-4 min-h-screen">
      ...
      <div className="max-w-screen mx-auto grid md:grid-cols-2 pt-8">
        <div className="flex flex-col items-center">
          ...
          <button className="animate-wiggle bg-gradient-to-r from-gray-400 via-gray-500 to-gray-600 text-white w-[200px] rounded-md font-medium my-6 mx-auto lg:md:mx-0 py-3 hover:bg-gradient-to-l lg:md:w-[200px] lg:md:h-[60px] lg:md:text-xl">
