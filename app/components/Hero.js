  ...
  return (
    <div className="text-white flex flex-col min-h-screen">
      ...
      <div className="absolute top-0 w-full min-h-screen flex flex-col justify-center items-center z-20 ">
        ...
        <br />
        <button className="animate-pulse animate-infinite animate-ease-in animate-fill-backwards bg-gradient-to-l from-gray-600 via-gray-500 to-gray-400 text-white w-[200px] rounded-md font-medium my-6 mx-auto lg:md:mx-0 py-3 hover:bg-gradient-to-r  lg:md:w-[200px] lg:md:h-[60px] lg:md:text-xl opacity-80">
