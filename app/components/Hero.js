  ...
  return (
    <div className="text-white flex min-h-screen">
      ...
      <div className="absolute top-0 w-full h-screen flex flex-col justify-center items-center">
        ...
        <br />
        <p className="text-white-900 text-2xl p-2  md:text-5xl text-center">
          <span className="text-5xl p-4">Logistique </span>
          <br />
          <span className="text-4xl">et </span>
          <br />
          <span className="text-5xl">Transports</span>
        </p>
        <br />
